...
parser.add_argument('--epoch_step', default=[30], type=int, nargs='+',
                    help='number of epochs to change learning rate (default: 30)')
parser.add_argument('--start-epoch', default=0, type=int, metavar='N',
                    help='manual epoch number (useful on restarts)')
parser.add_argument('--checkpoint', default='./checkpoint/voc2007/', 
                    type=str, metavar='DIR', help='where to store checkpoints')
...
parser.add_argument('--device', default=0, metavar='N', type=int, 
                    help='device (-1 for cpu)')
